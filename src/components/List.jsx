  ...
  const handleMouseMove = useCallback(
    (event) => {
      ...
      listRef.current.forEach((el) =>
        animateElement(el, event.clientX, event.clientY)
      );
    },
    [animateElement]
  );
        ...
        >
          <div className="relative w-full sm:flex sm:items-center justify-between z-[3]">
            <div className="left sm:flex items-center gap-14 sm:text-5xl">
              ...
              <h1 className="text-blue-600 text-3xl sm:text-black sm:text-[6vh]">
                {item.title}
              </h1>
            </div>
          ...
          <div
            className="picture w-[14vh] h-[14vh] opacity-0 right-0
